...
def get_args():
    ...
    parse.add_argument('--sd_version', type=str, choices=["1.5", "2.0", "2.1-base", "2.1"], default="2.1")
    ...
    parse.add_argument('--sty_folder', type=str, required=True)
    parse.add_argument('--sty_no', type=int, required=True)
    parse.add_argument('--save_dir', type=str, default='results')
    parse.add_argument('--result_fn', type=str, default='result')
