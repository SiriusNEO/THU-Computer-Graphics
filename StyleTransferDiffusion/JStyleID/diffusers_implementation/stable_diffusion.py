...
def load_stable_diffusion(sd_version='2.1', precision_t=jt.float32, device="cuda"):
    if sd_version == '2.1':
...
def attention_op(attn, hidden_states, encoder_hidden_states=None, attention_mask=None, query=None, key=None, value=None, attention_probs=None, temperature=1.0):
    ...
    hidden_states = jt.bmm(attention_probs, value) # torch.bmm(attention_probs, value)
